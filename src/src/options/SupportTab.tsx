...
const FAQS = [
    ...
    { q: 'Can I sync with Notion or Google Calendar?', a: 'Notion task sync and Google Calendar integration are rolling out. Use the built-in daily planner, Sessions tab deep work planner, and scheduling calendar today.' },
